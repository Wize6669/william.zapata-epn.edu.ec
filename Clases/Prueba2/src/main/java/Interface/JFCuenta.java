...
public class JFCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTASaldo.setBackground(new java.awt.Color(255, 255, 255));
        jTASaldo.setColumns(20);
        jTASaldo.setRows(5);
        jScrollPane1.setViewportView(jTASaldo);

        jLabel4.setText("Valor a Depositarar: ");

        jLabel5.setText("Valor a Retirar");

        jTFDeposito.setBackground(new java.awt.Color(255, 255, 255));
        jTFDeposito.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTFDepositoActionPerformed(evt);
            }
        });
        jTFDeposito.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTFDepositoKeyPressed(evt);
            }
        });

        jTFRetiro.setBackground(new java.awt.Color(255, 255, 255));
        jTFRetiro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTFRetiroActionPerformed(evt);
            }
        });
        jTFRetiro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTFRetiroKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTFNumeroCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(jTFRetiro, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jTFNumeroCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTFNumeroCuentaActionPerformed
        ...
        try{
        cuenta.setNumeroCuenta(Integer.parseInt(this.jTFNumeroCuenta.getText()));
        this.jTFDeposito.requestFocus();
        }catch(NumberFormatException e){
        JOptionPane.showMessageDialog(null, "Por valor Ingrese números un numero de cuenta");
        this.jTFNumeroCuenta.requestFocus();
        }
    }//GEN-LAST:event_jTFNumeroCuentaActionPerformed

    private void jBAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAceptarActionPerformed
        cuenta.setCuenta(Long.parseLong(this.jTFNumeroCuenta.getText()),Float.parseFloat(this.jTFDeposito.getText()));
        salida += cuenta.toString();
                // " fue: "+ Long.parseLong(this.jTFRetiro.getText());
        this.jTASaldo.setText(salida);
        
    }//GEN-LAST:event_jBAceptarActionPerformed

    private void jBNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNuevoActionPerformed
        this.jTFNumeroCuenta.setText("");
    ...
    private void jTFDepositoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFDepositoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTFDepositoKeyPressed
    ...
    private void jTFRetiroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFRetiroKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTFRetiroKeyPressed

    private void jTFDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTFDepositoActionPerformed
        try{
            cuenta.setDepositar(Float.parseFloat(this.jTFDeposito.getText()));
    ...
    private void jTFRetiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTFRetiroActionPerformed
        try{
            float valor;
            valor = Float.parseFloat(this.jTFRetiro.getText());
            if(cuenta.setRetirar(Float.parseFloat(this.jTFDeposito.getText())) == 0 ){
             JOptionPane.showMessageDialog(null, "No dispone de saldo suficiente !!");
             this.jTFRetiro.setText("");
             this.jTFRetiro.requestFocus();
            } else{
            this.jTFRetiro.requestFocus();
            ...
            JOptionPane.showMessageDialog(null, "Ingrese el valor en numeros  !!");
            this.jTFRetiro.requestFocus();
        }
