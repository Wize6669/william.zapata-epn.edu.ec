...
public class JFSuma extends javax.swing.JFrame {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(jTFM1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(26, 26, 26)
    ...
    private void jBAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAceptarActionPerformed
        ...
        this.matrizr = new Matriz(Integer.parseInt(jTFN1.getText()), Integer.parseInt(jTFM1.getText()));
        matriz1.setMatriz();
        matriz2.setMatriz();
        salida+="Matriz1 \n"+matriz1.toString();
        salida+="Matriz2 \n"+matriz2.toString();
        this.matrizr=matriz1.sumaMatrices(matriz2);
        if(matrizr==null){
            salida += "No es posible Sumar!!";
        }else{
            salida += "Matriz Suma: \n" +matrizr.toString();
        }
